package net.gshp.apiencuesta.model.DAO;

import java.util.ArrayList;
import java.util.List;

import net.gshp.apiencuesta.model.DTO.EAEncuesta;
import net.gshp.apiencuesta.model.DTO.EAGrupo;
import net.gshp.apiencuesta.model.DTO.EAOpcionPregunta;
import net.gshp.apiencuesta.model.DTO.EAPregunta;
import net.gshp.apiencuesta.model.DTO.EARespuesta;
import net.gshp.apiencuesta.model.DTO.EASeccion;
import net.gshp.apiencuesta.model.DTO.EATipoPregunta;
